...
public class ImmersionBar {
    ...
    private void initBar() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                mWindow.setStatusBarColor(BarUtils.blendARGB(mBarParams.statusBarColor,
                                                             mBarParams.statusBarColorTransform, mBarParams.statusBarAlpha
                                                            ));  //设置状态栏颜色
                mWindow.setNavigationBarColor(BarUtils.blendARGB(mBarParams.navigationBarColor,
    ...
    private int setStatusBarDarkFont(int uiFlags) {
        String MIUIVersion = BarUtils.MIUIVersion();
    ...
    private void transformView() {
        if (mBarParams.view != null) {
            mBarParams.view.setBackgroundColor(BarUtils.blendARGB(mBarParams.viewColorBeforeTransform,
        ...
        if (mBarParams.viewMap.size() != 0) {
            ...
            for (Map.Entry<View, Map<Integer, Integer>> entry : entrySet) {
                ...
                if (view != null)
                    view.setBackgroundColor(BarUtils.blendARGB(colorBefore, colorAfter, mBarParams.statusBarAlpha));
    ...
    private void setupStatusBarView() {
        ...
        mBarParams.statusBarView.setBackgroundColor(BarUtils.blendARGB(mBarParams.statusBarColor,
                                                                       mBarParams.statusBarColorTransform, mBarParams.statusBarAlpha
                                                                      ));
    ...
    private void setupNavBarView() {
        ...
        if (!mBarParams.fullScreen && (mBarParams.navigationBarColorTransform == Color.TRANSPARENT)) {
            mBarParams.navigationBarView.setBackgroundColor(BarUtils.blendARGB(mBarParams.navigationBarColor,
